    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <link rel="stylesheet"
                    href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css" media="print"
            ...
            <body>
                ...
                <script>
                    // 장치 타입 전역 변수 설정 (히터/쿨러 아이콘 표시용)
                    window.deviceType = '${deviceType}' || '0';
                    console.log('차트 페이지 - 장치 타입 설정:', window.deviceType, (window.deviceType === '1' ? '히터' : '쿨러'));

                    // 페이지 로딩 시 장치 아이콘 초기화
                    function initializeChartDeviceIcons() {
                        var deviceType = window.deviceType || '0';
                        console.log('차트 페이지 아이콘 초기화 - deviceType:', deviceType);

                        // 제상/히터 라벨 업데이트
                        if (typeof updateDefrostLabel === 'function') {
                            updateDefrostLabel('defrostLabelChart', deviceType);
                        }

                        // 제상/히터 아이콘 업데이트
                        if (typeof updateDefrostIndicator === 'function') {
                            updateDefrostIndicator('defrChart', 'gray', deviceType);
                        }
                    }

                    // DOMContentLoaded 이벤트 또는 즉시 실행
                    if (document.readyState === 'loading') {
                        document.addEventListener('DOMContentLoaded', initializeChartDeviceIcons);
                    } else {
                        initializeChartDeviceIcons();
                    }

                    // MQTT 연결 완료 후 장치 타입 조회 (GET&type=1)
                    window.addEventListener('mqtt:connected', function () {
                        console.log('차트 페이지 - MQTT 연결 완료, 장치 타입 조회 시작');
                        // 0.5초 후 GET&type=1 요청 (설정값 조회)
                        setTimeout(function () {
                            if (typeof setSensor === 'function') {
                                setSensor();
                                console.log('차트 페이지 - GET&type=1 요청 전송 완료');
                            }
                        }, 500);
                    });
                </script>
                    ...
                    <div class="template-page-wrapper">
                        <div class="navbar-collapse collapse templatemo-sidebar">
                            <ul class="templatemo-sidebar-menu">
                                <li class="active"><a href="javascript:PageNavigation.goMain();"><i
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 margin-bottom-30">
                                            <div class="panel panel-primary">
                                                <div class="panel-heading" id="deviceNm">${sensorName}</div>
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-striped"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td align="center"
                                                                    style="background-color: #c7254e; width: 30%;">
                                                                    <strong><span
                                                                            style="color: #f0f8ff; ">구분</span></strong>
                                                                </td>
                                                                <td align="center"
                                                                    style="background-color: #c7254e; width: 70%;">
                                                                    <strong><span
                                                                            style="color: #f0f8ff; ">온도</span></strong>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="center" style="width: 70%;">
                                                                    <strong><span align="center" id="setTmp"
                                                                            name="setTmp"
                                                                            style="color: #4cae4c"></span></strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" valign="middle" style="width: 30%;">
                                                                    현재온도</td>
                                                                <td align="center" style="width: 70%;">
                                                                    <strong><span align="center" id="sensorVal"
                                                                            name="sensorVal"
                                                                            style="color: #c7254e"></span></strong>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="20%" align="center" valign="middle"
                                                                    style="background-color: #c7254e;"><strong><span
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <div id="statusChart"
                                                                        class="status-indicator green"><i
                                                                            class="bi bi-play-circle-fill"></i></div>
                                                                </td>
                                                                <td align="center">
                                                                    <div id="compChart" class="status-indicator gray"><i
                                                                            class="bi bi-gear-fill"></i></div>
                                                                </td>
                                                                <td align="center">
                                                                    <div id="defrChart" class="status-indicator gray"><i
                                                                            class="bi bi-snow defrost-icon"></i><i
                                                                            class="bi bi-fire heater-icon"
                                                                            style="display:none;"></i></div>
                                                                </td>
                                                                <td align="center">
                                                                    <div id="fanChart" class="status-indicator gray"><i
                                                                            class="bi bi-fan"></i></div>
                                                                </td>
                                                                <td align="center">
                                                                    <div id="errorChart" class="status-indicator gray">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <td colspan="5" align="center"
                                                                    ...
                                                                    <strong><span
                                                                            style="color: #f0f8ff; font-size:10pt;">날짜</span></strong>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="5" align="center" style="width: 100%;">
                                                                    <div
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-default" id="prevDay"
                                                                            title="이전 날짜"
                                                                            style="padding: 2px 6px; max-width: 100%;">
                                                                            <i class="bi bi-chevron-left"></i>
                                                                        </button>
                                                                        <input type="date" id="startDate"
                                                                            name="startDate" value="${todayStr}"
                                                                            style="width: 110px; height: 22px; text-align: center; max-width: 100%;">
                                                                        ~ <input type="date" id="endDate" name="endDate"
                                                                            value="${todayStr}"
                                                                            style="width: 110px; height: 22px; text-align: center; max-width: 100%;">
                                                                        <button type="button"
                                                                            class="btn btn-sm btn-default" id="nextDay"
                                                                            title="다음 날짜"
                                                                            style="padding: 2px 6px; max-width: 100%;">
                                                            ...
                                                            <tr>
                                                                <td colspan="5" align="center" style="width: 100%;">
                                                                    <button type="button" class="btn btn-default"
                                                                        id="1mon" name="1mon"
                                                                        style="max-width: 100%; margin: 2px;">1개월</button>
                                                                    <button type="button" class="btn btn-default"
                                                                        id="3mon" name="3mon"
                                                                        style="max-width: 100%; margin: 2px;">3개월</button>
                                                                    <button type="button" class="btn btn-default"
                                                                        id="6mon" name="6mon"
                                                                        style="max-width: 100%; margin: 2px;">6개월</button>
                                                                    <button type="button" class="btn btn-default"
                                                                        id="12mon" name="12mon"
                                                                        style="max-width: 100%; margin: 2px;">1년</button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="5" align="center" style="width: 100%;">
                                                                    <button type="button" class="btn btn-default"
                                                                        id="excelDownload" name="excelDownload"
                                                                        style="max-width: 100%;">다운로드</button></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                ...
                <script type="text/javascript">
                    ...
                    function updateStatusIndicatorFromOutput(type, value) {
                        ...
                        // defr인 경우 updateDefrostIndicator 사용 (아이콘도 함께 업데이트)
                        if (type === 'defr') {
                            var currentDeviceType = window.deviceType || '0';
                            updateDefrostIndicator('defrChart', status, currentDeviceType);
                        } else {
                                ...
                                if (message) {
                                    if (validateJson(message)) {
                                        ...
                                        if (msg.actcode == 'setres') {
                                            ...
                                            // p16 값으로 장치 타입 업데이트 (히터/쿨러)
                                            if (msg.p16 !== undefined && msg.p16 !== null) {
                                                window.deviceType = String(msg.p16);
                                                console.log('차트 페이지 - 장치 타입 업데이트 (MQTT):', window.deviceType, (window.deviceType === '1' ? '히터' : '쿨러'));

                                                // 장치 이름에 장치 종류 추가 (예: "0008DC755397" -> "0008DC755397(히터)")
                                                var baseSensorName = $('#sensor_name').val() || $('#sensorUuid').val();
                                                var deviceTypeText = (window.deviceType === '1') ? '히터' : '쿨러';
                                                var displayName = baseSensorName + '(' + deviceTypeText + ')';
                                                $('#deviceNm').text(displayName);
                                                console.log('차트 페이지 - 장치 이름 업데이트:', displayName);

                                                // 제상/히터 라벨 및 아이콘 업데이트
                                                if (typeof updateDefrostLabel === 'function') {
                                                    updateDefrostLabel('defrostLabelChart', window.deviceType);
                                                }
                                                // 현재 상태에 맞춰 아이콘 업데이트
                                                if (typeof updateDefrostIndicator === 'function') {
                                                    var currentStatus = $('#defrChart img').hasClass('active') ? 'red' : 'gray';
                                                    updateDefrostIndicator('defrChart', currentStatus, window.deviceType);
                                                }
                                            }
                    ...
                    // refreshChartData 함수 제거 - loadChartData로 통합됨
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (response.resultCode === '200' && response.dailyData) {
                                    ...
                                    alert('데이터를 불러올 수 없습니다: ' + response.resultMessage);
                                }
                            },
                            error: function (xhr, status, error) {
                                ...
                                hideLoading();
                                isLoadingChartData = false;
                                alert('데이터 로드 중 오류가 발생했습니다: ' + error);
                            }
                        });
                    }
                    ...
                    function updateChartWithNewData(dailyData) {
                        ...
                        // 데이터를 labels와 data 배열로 변환
                        var labels = [];
                        var data = [];
                        
                        for (var i = 0; i < window.dailyArr.length; i++) {
                            var parts = window.dailyArr[i].split('^');
                            if (parts.length === 2) {
                                labels.push(parts[0]);
                        ...
                        // 차트가 이미 존재하면 데이터만 업데이트 (재생성 없음)
                        if (window.dailyChart && window.dailyChart.data) {
                            console.log('기존 차트 데이터 업데이트 (재생성 없음)');
                            window.dailyChart.data.labels = labels;
                            window.dailyChart.data.datasets[0].data = data;
                            window.dailyChart.update({
                                duration: 300,  // 애니메이션 시간 단축 (기본 1000ms → 300ms)
                                lazy: false
                            });
                            console.log('차트 데이터 업데이트 완료 (재생성 없음)');
                        } else {
                            // 차트가 없으면 새로 생성
                            console.log('차트 초기 생성');
                            initializeChart();
                            console.log('차트 초기 생성 완료');
                        }
                    }
                    ...
                    function showLoading() {
                        ...
                        if ($('#loadingSpinner').length === 0) {
                            $('body').append('<div id="loadingSpinner" style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:9999;background:rgba(255,255,255,0.9);padding:20px;border-radius:10px;box-shadow:0 4px 6px rgba(0,0,0,0.1);"><div style="text-align:center;"><div class="spinner-border text-primary" role="status" style="width:3rem;height:3rem;"><span class="sr-only">Loading...</span></div><div style="margin-top:10px;color:#333;">데이터 로딩 중...</div></div></div>');
                        }
                        $('#loadingSpinner').show();
                        
                        // 날짜 변경 버튼 비활성화
                        $('#startDate, #endDate').prop('disabled', true);
                        $('button[onclick*="prev"], button[onclick*="next"]').prop('disabled', true);
                        $('.btn-period').prop('disabled', true);
                    ...
                    function hideLoading() {
                        ...
                        $('button[onclick*="prev"], button[onclick*="next"]').prop('disabled', false);
                        $('.btn-period').prop('disabled', false);
                        
                        console.log('로딩 표시 해제');
                    }
