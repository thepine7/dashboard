                            ...
                            <div class="panel-body">
                                <table class="table table-striped" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="50%" align="center" valign="middle" style="background-color: #c7254e;">
                                                <strong><span style="color: #f0f8ff; font-size:10pt;">Line Chart</span></strong>
                                            </td>
                                            <td width="50%" align="center" valign="middle" style="background-color: #c7254e;">
                                                <strong><span style="color: #f0f8ff; font-size:10pt;">Bar Chart</span></strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" align="center" valign="middle">
                                                <img src="/images/linechart.svg" width="70%" height="75%">
                                            </td>
                                            <td width="50%" align="center" valign="middle">
                                                <img src="/images/barchart.svg" width="70%" height="75%">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" align="center" valign="middle"><input type="radio" id="line" name="chart" value="line"></td>
                                            <td width="50%" align="center" valign="middle"><input type="radio" id="bar" name="chart" value="bar"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center" valign="middle" style="background-color: #f8f9fa;">
                                                <strong><span style="font-size:10pt;">사용안함</span></strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center" valign="middle">
                                                <input type="radio" id="none" name="chart" value="none">
                                            </td>
                                        </tr>


                                        <tr>
                                            <td colspan="2" align="center" style="padding-top: 15px; padding-bottom: 15px;"><strong><span style="font-size: 12px;"><button id="save" name="save">설정 저장</button></span></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
