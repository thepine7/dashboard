                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body form-horizontal templatemo-signin-form">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label for="subId"
                                                                        class="col-sm-2 control-label">아이디</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            id="subId" placeholder="사용자 아이디">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label for="subPass"
                                                                        class="col-sm-2 control-label">비밀번호</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            id="subPass" placeholder="비밀번호">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label for="subUserTel"
                                                                        class="col-sm-2 control-label">전화번호</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            id="subUserTel" placeholder="전화번호">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <label for="subUserEmail"
                                                                        class="col-sm-2 control-label">메일주소</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            id="subUserEmail" placeholder="메일주소">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-sm-offset-2 col-sm-10"
                                                                        ...
                                                                        <input type="submit" id="join" name="join"
                                                                            value="부계정생성" class="btn btn-default">
                                                                    </div>
                                                                </div>
                                                            </div>
