...
<head>
    ...
    <style>
      ...
      /* 특정 컬럼 너비 조정 */
      .table td:nth-child(1), .table th:nth-child(1) { width: 15%; } /* 이름 */
      .table td:nth-child(2), .table th:nth-child(2) { width: 15%; } /* 아이디 */
      .table td:nth-child(3), .table th:nth-child(3) { width: 15%; } /* 주계정아이디 */
      .table td:nth-child(4), .table th:nth-child(4) { width: 8%; }  /* 등급 */
      .table td:nth-child(5), .table th:nth-child(5) { width: 15%; } /* 로그인상태 */
      .table td:nth-child(6), .table th:nth-child(6) { width: 12%; } /* 삭제 */
            ...
            <div class="templatemo-panels">
                <div class="row">
                    <div class="" style="margin-right: 10px; margin-left: 10px;">
                        <span class="btn btn-primary"><a href="javascript:PageNavigation.goUserList();">사용자 관리</a></span>
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">이름</span></strong></td>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">아이디</span></strong></td>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">주계정아이디</span></strong></td>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">등급</span></strong></td>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">로그인상태</span></strong></td>
                                            <td align="center" valign="middle" style="background-color: #c7254e;"><strong><span style="color: #f0f8ff; font-size:10pt;" height="25">삭제</span></strong></td>
                                        </tr>
                                    </thead>
                                        <tbody id="userList">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="item" items="${userList}">
                                                    <tr class="user-table-row">
                                                        <td onclick="userDetail('${item.userId}');" align="center" valign="middle" style="background-color: #ffffff;" height="25"><strong><span style="font-size:10pt;">${item.userNm}</span></strong></td>
                                                        <td onclick="userDetail('${item.userId}');" align="center" valign="middle" style="background-color: #ffffff;" height="25"><strong><span style="font-size:10pt;">${item.userId}</span></strong></td>
                                                        <td onclick="userDetail('${item.userId}');" align="center" valign="middle" style="background-color: #ffffff;" height="25"><strong><span style="font-size:10pt;">${item.mainId}</span></strong></td>
                                                        <td onclick="userDetail('${item.userId}');" align="center" valign="middle" style="background-color: #ffffff;" height="25"><strong><span style="font-size:10pt;">${item.userGrade}</span></strong></td>
                                                        <td onclick="userDetail('${item.userId}');" align="center" valign="middle" style="background-color: #ffffff;" height="25">
                                                            <strong>
                                                                <span style="font-size:10pt; padding: 4px 8px; border-radius: 4px; color: white; font-weight: bold; 
                                                                       ${item.loginYn eq '활성' ? 'background-color: #4CAF50;' : 'background-color: #9e9e9e;'}">
                                                                    ${item.loginYn}
                                                                </span>
                                                            </strong>
                                                        </td>
                                                        <td align="center" valign="middle" style="background-color: #f0f0f0;" height="25">
                                                            <strong>
                                                                <span style="font-size:10pt;">
                                                                    <c:choose>
                                                                        <c:when test="${userGrade eq 'A' && item.userId eq loginUserId}">
                                                                            <!-- A등급 사용자 자기 자신: "---" 텍스트 직접 표시 -->
                                                                            <span style="color: #666666; font-style: italic;">---</span>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <button id="delete" name="delete" class="delete-btn" style="width:50px; height:30px;" onclick="deleteUser('${item.userId}');">삭제</button>
                                                                        </c:otherwise>
                                                                    </c:choose>
                                                                </span>
                                                            </strong>
