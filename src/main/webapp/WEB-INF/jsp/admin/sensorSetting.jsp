						...
						<body>
							...
							<div class="navbar navbar-inverse" role="navigation" style="background-color: #ffffff">
								<div class="navbar-header">
									<div class="logo">
										<h1><a href="/main/main"><img src="/images/hntbi.png" width="70"
													height="32"></a></h1>
									</div>
							...
							<div class="template-page-wrapper">
										...
										<li class="sub open">
											...
											<c:if test="${userGrade eq 'A' || userGrade eq 'U'}">
												...
												<ul class="templatemo-submenu">
													<li><a
															href="/admin/userList?userId=${userId}&userGrade=${userGrade}">사용자
															관리</a></li>
												</ul>
												<ul class="templatemo-submenu">
													<li><a
															href="/admin/createSub?userId=${userId}&userGrade=${userGrade}">부계정
															생성</a></li>
												</ul>
											</c:if>
										</li>
								...
								<div class="templatemo-content-wrapper" style="background-color: #333333">
									<div class="templatemo-content" style="background-color: #333333">
										<ol class="breadcrumb">
											<li><a href="/main/main" onclick="goMain()">메인</a></li>
										</ol>
										...
										<div class="templatemo-panels">
											<div class="row">
												<div class="" style="margin-right: 10px; margin-left: 10px;">
													<span class="btn btn-primary"><a href="javascript:void(0);"
															onclick="refreshDeviceSettings()">장치설정</a></span>
													<div class="panel panel-primary">
														<div class="panel-heading"><strong><span
																	id="deviceName${sensorUuid}">${not empty sensor_name
																	? sensor_name : sensorUuid}</span> <span
																	id="deviceType${sensorUuid}"
																	style="font-size: 12px; color: #ccc;">(장치종류)</span></strong>
														</div>
														<div class="panel-body">
															<!-- 센서 정보 표시 -->
															<div
																style="background-color: #d9edf7; padding: 10px; margin-bottom: 15px; border-radius: 5px;">
																<div style="font-weight: bold; margin-bottom: 5px;">센서
																	정보</div>
																<div style="font-size: 12px; line-height: 1.4;">
																	<div><strong>센서 정보:</strong> <span
																			id="deviceSensorInfoDisplay">-</span></div>
																	<div><strong>온도 범위:</strong> <span
																			id="deviceTempRangeDisplay">-</span></div>
																	<div><strong>장치 종류:</strong> <span
																			id="deviceDeviceTypeDisplay">-</span></div>
																</div>
															</div>
																...
																<thead>
																	<tr>
																		<td align="center" valign="middle"
																			...
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">현재온도</span></strong>
																		</td>
																		<td align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">설정온도</span></strong>
																		</td>
																		<td align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">강제재상</span></strong>
																		</td>
																	</tr>
																</thead>
																<tbody>
																	<tr>
																		<td align="center" valign="middle"><strong>
																				<p align="center" id="curTemp"
																					name="curTemp"
																					style="font-size: 30px; color: #c9302c">
																				</p>
																			</strong></td>
																		<td align="center" valign="middle"><strong><span
																					id="setTemp" name="setTemp"
																					style="font-size: 30px; color: #3c763d"></span></strong>
																		</td>
																		<td align="center" valign="middle"
																			style="padding-right:12px;">
																			<div
																				style="display:flex; flex-direction:column; justify-content:center; align-items:center; gap:8px;">
																				<button id="defrost" name="defrost"
																					class="btn-soft btn-on-soft defrost-btn"
																					style="font-size: 13px; width:140px;">강제제상</button>
																				<button id="stopDefrost" name="defrost"
																					class="btn-soft btn-off-soft defrost-btn"
																					style="font-size: 13px; width:140px;">강제제상종료</button>
																			</div>
																		</td>
																	</tr>
																	<tr>
																		<td align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">상태</span></strong>
																		</td>
																		<td colspan="2">
																			...
																			<table class="table table-striped">
																				<thead>
																					<tr>
																						<td align="center">
																							<div id="status${sensorUuid != null ? sensorUuid : ''}"
																						...
																						<td align="center">
																							<div id="comp${sensorUuid != null ? sensorUuid : ''}"
																								class="status-indicator gray">
																								<i
																									class="bi bi-gear-fill"></i>
																							</div>
																						</td>
																						<td align="center">
																							<div id="defr${sensorUuid != null ? sensorUuid : ''}"
																								class="status-indicator gray">
																								<i
																									class="bi bi-snow defrost-icon"></i><i
																									class="bi bi-fire heater-icon"
																									style="display:none;"></i>
																							</div>
																						</td>
																						<td align="center">
																							<div id="fan${sensorUuid != null ? sensorUuid : ''}"
																								class="status-indicator gray">
																								<i
																									class="bi bi-fan"></i>
																							</div>
																						...
																						<td align="center">
																							<div id="error${sensorUuid != null ? sensorUuid : ''}"
																								class="status-indicator gray">
																								<i
																				...
																				<tbody>
																					<tr>
																						<td width="20%" align="center"
																							...
																							style="background-color: #c7254e;">
																							<strong><span
																									style="color: #f0f8ff; font-size:10pt;">운전</span></strong>
																						</td>
																						<td width="20%" align="center"
																							valign="middle"
																							style="background-color: #c7254e;">
																							<strong><span
																									style="color: #f0f8ff; font-size:10pt;">콤프</span></strong>
																						</td>
																						<td width="20%" align="center"
																							valign="middle"
																							style="background-color: #c7254e;">
																							<strong><span
																									id="defrostLabel${sensorUuid != null ? sensorUuid : ''}"
																									style="color: #f0f8ff; font-size:10pt;">제상</span></strong>
																						</td>
																						<td width="20%" align="center"
																							valign="middle"
																							style="background-color: #c7254e;">
																							<strong><span
																									style="color: #f0f8ff; font-size:10pt;">FAN</span></strong>
																						</td>
																						<td width="20%" align="center"
																							valign="middle"
																							style="background-color: #c7254e;">
																							<strong><span
																									style="color: #f0f8ff; font-size:10pt;">이상</span></strong>
																						</td>
																					</tr>
																				</tbody>
																			</table>
															...
															<table class="table table-striped">
																<thead>
																	<tr>
																		<td width="25%" align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">항목</span></strong>
																		</td>
																		<td width="25%" align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																					style="color: #f0f8ff; font-size:10pt;">설정값</span></strong>
																		</td>
																		<td width="25%" align="center" valign="middle"
																			style="background-color: #c7254e;">
																			<strong><span
																...
																<tbody>
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">설정온도</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																			<c:if test="${userGrade ne 'B'}">
																				<input type="text" id="p01" name="p01"
																					value="" style="width:50px;"
																					onblur="validateTemperatureInput(this)" />°C
																			</c:if>
																		...
																		<td align="center" valign="middle"
																			style="font-size:10pt;">장치종류</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																			<select id="p16" name="p16"
																				style="width:60px; font-size:10pt;">
																	...
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">히스테리시스<br>편차</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p02" name="p02" value=""
																				style="width:50px;"
																				onblur="validateHysteresisInput(this)" />°C
																		</td>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">제상 시간<br>(min)</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p06" name="p06" value=""
																				style="width:50px;"
																				onblur="validateMinuteInput(this)" />분
																		</td>
																	</tr>
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">COMP 출력<br>지연시간(sec)
																		</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p03" name="p03" value=""
																				style="width:50px;"
																				onblur="validateDelayInput(this)" />초
																		</td>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">팬설정</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																			<select id="p07" name="p07"
																				style="width:60px; font-size:10pt;">
																				<option value="">선택</option>
																	...
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">온도보정</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p04" name="p04" value=""
																				style="width:50px;"
																				onblur="validateTemperatureCompensationInput(this)" />°C
																		</td>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">제상 후 FAN
																			ON<br>지연시간(sec)</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p08" name="p08" value=""
																				style="width:50px;"
																				onblur="validateDelayInput(this)" />초
																		</td>
																	</tr>
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">제상 정지시간<br>(hour)
																		</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p05" name="p05" value=""
																				style="width:50px;"
																				onblur="validateHourInput(this)" />시간
																		</td>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">FAN OFF<br>지연시간(sec)
																		</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p09" name="p09" value=""
																				style="width:50px;"
																				onblur="validateDelayInput(this)" />초
																		</td>
																	</tr>
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">저온방지<br>온도편차</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;"><input type="text"
																				id="p10" name="p10" value=""
																				style="width:50px;"
																				onblur="validateLowTempPreventionInput(this)" />°C
																		</td>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">COMP 누적 시간<br>제상 선택
																		</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																			<select id="p11" name="p11"
																				style="width:60px; font-size:10pt;">
																				<option value="">선택</option>
																	...
																	<tr>
																		<td align="center" valign="middle"
																			style="font-size:10pt;">온도 센서<br>타입</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																		...
																		<td align="center" valign="middle"
																			style="font-size:10pt;">수동조작<br>on/off</td>
																		<td align="left" valign="middle"
																			style="font-size:10pt;">
																		...
																		<td colspan="4" align="center"
																			...
																			<div style="margin-bottom:8px;">
																				<c:if test="${userGrade ne 'B'}">
																					<!-- COMP(Type=1) -->
																					<div
																						style="display:flex; justify-content:center; align-items:center; margin:6px 0; gap:10px;">
																						<span
																							style="width:60px; text-align:right; color:#333; font-weight:bold;">콤프
																							:</span>
																						<div
																							style="display:inline-flex; gap:8px;">
																							<button
																								class="out-btn btn-soft btn-on-soft device-output-btn"
																								data-type="1"
																								data-ch="1"
																								data-val="1">ON</button>
																							<button
																								class="out-btn btn-soft btn-off-soft device-output-btn"
																								data-type="1"
																								data-ch="1"
																					...
																					<div
																						style="display:flex; justify-content:center; align-items:center; margin:6px 0; gap:10px;">
																						<span
																							style="width:60px; text-align:right; color:#333; font-weight:bold;">제상
																							:</span>
																						<div
																							style="display:inline-flex; gap:8px;">
																							<button
																					...
																					<div
																						style="display:flex; justify-content:center; align-items:center; margin:6px 0; gap:10px;">
																						<span
																							style="width:60px; text-align:right; color:#333; font-weight:bold;">팬
																							:</span>
																						<div
																							style="display:inline-flex; gap:8px;">
																							<button
																				...
																				<c:if test="${userGrade eq 'B'}">
																					<div style="text-align:center;">
																						<span
																							style="color:#999; font-size:10pt;">읽기
																							전용 (출력 제어 불가)</span></div>
																				</c:if>
																			</div>
																			<c:if test="${userGrade ne 'B'}">
																				<button id="saveSensor"
																					name="saveSensor"
																					style="width:120px; height:30px;">장치설정저장</button>
																			</c:if>
																			<c:if test="${userGrade eq 'B'}">
																				<span
																					style="color: #999; font-size:10pt;">읽기
											...
											<div class="row">
												<div class="" style="margin-right: 10px; margin-left: 10px;">
													<span class="btn btn-primary"><a href="javascript:void(0);"
															onclick="refreshAlarmSettings()">알람설정</a></span>
													<div class="panel panel-primary">
														<div class="panel-heading"><strong><span
																	id="deviceName2${sensorUuid}">${not empty
																	sensor_name ? sensor_name : sensorUuid}</span> <span
																	id="deviceType2${sensorUuid}"
																	style="font-size: 12px; color: #ccc;">(장치종류)</span></strong>
														</div>
														<div class="panel-body">
															<!-- 센서 정보 표시 -->
															<div
																...
																<div style="font-size: 12px; line-height: 1.4;">
																	<div><strong>센서 정보:</strong> <span
																			id="alarmSensorInfoDisplay">${sensorDisplayName
																			!= null ? sensorDisplayName : '-'}</span>
																	</div>
																	<div><strong>온도 범위:</strong> <span
																			id="alarmTempRangeDisplay">${tempRange !=
																			null ? tempRange : '-'}</span></div>
																	<div><strong>장치 종류:</strong> <span
																			id="alarmDeviceTypeDisplay">${deviceTypeText
																			!= null ? deviceTypeText : '-'}</span></div>
																</div>
															</div>
															<table class="table table-striped">
																<tr>
																	<th width="15%" align="center" rowspan="2"
																		style="font-size: 12pt;">고온알람</th>
																</tr>
																<tr valign="middle">
																	<td width="80%">
																		<table border="1" style="border-color: #ffffff"
																			...
																			<tr>
																				<td width="50%" height="30"
																					style="background-color: #c7254e; font-size:10pt;"
																					align="center"><strong><span
																							style="color: #f0f8ff; font-size:10pt;">알람</span></strong>
																				</td>
																				<td width="50%" height="30"
																					style="background-color: #c7254e; font-size:10pt;"
																					align="center"><strong><span
																			...
																			<tr>
																				<td align="center">
																					<select id="alarmYn1"
																						name="alarmYn1"
																						style="width:65px; font-size:10pt;">
																				...
																				<td align="center"
																					style="font-size:10pt;">
																					<input type="text" id="setVal1"
																						name="setVal1"
																						style="width:60px; font-size:10pt;">이상
																				</td>
																			</tr>
																		</table>
																		<table border="1" style="border-color: #ffffff"
																			...
																			<tr>
																				<td width="50%" height="30"
																					style="background-color: #c7254e; font-size:10pt;"
																					align="center"><strong><span
																							style="color: #f0f8ff; font-size:10pt;">지연시간</span></strong>
																				</td>
																<td width="50%" height="30"
																	style="background-color: #c7254e; font-size:10pt;"
																	align="center"><strong><span
																			style="color: #f0f8ff; font-size:10pt;">재전송반복시간</span></strong>
																</td>
																			</tr>
																			<tr>
																				<td align="center">
																					<select id="delayHour1"
																						name="delayHour1"
																						style="width:60px; font-size:10pt;">
																						...
																						<option value="600">10시간
																						</option>
																						<option value="660">11시간
																						</option>
																						<option value="720">12시간
																						</option>
																						<option value="780">13시간
																						</option>
																						<option value="840">14시간
																						</option>
																						<option value="900">15시간
																						</option>
																						<option value="960">16시간
																						</option>
																						<option value="1020">17시간
																						</option>
																						<option value="1080">18시간
																						</option>
																						<option value="1140">19시간
																						</option>
																						<option value="1200">20시간
																						</option>
																						<option value="1260">21시간
																						</option>
																						<option value="1320">22시간
																						</option>
																						<option value="1380">23시간
																						</option>
																						<option value="1440">24시간
																						</option>
																					</select>
																					<select id="delayMin1"
																						name="delayMin1"
																		...
																		<table border="0" width="100%" height="500"
																			...
																			<tr valign="middle">
																				<td align="center">
																					<c:if test="${userGrade eq 'B'}">
																						<span
																							style="color: #999; font-size:8pt;">읽기전용</span>
																					</c:if>
																				</td>
																			</tr>
																		</table>
																	...
																	<td>
																		<table border="1" style="border-color: #ffffff"
																			...
																			<tr>
																				...
																				<td align="center"
																					style="font-size:10pt;">
																					<input type="text" id="setVal2"
																						name="setVal2" value=""
																						style="width:60px; font-size:10pt;" />이하
																				</td>
																			</tr>
																		</table>
																		<table border="1" style="border-color: #ffffff"
																...
																<tr>
																	<th align="center" rowspan="2"
																		style="font-size: 12pt;">특정온도알람</th>
																</tr>
																<tr>
																	<td>
																		<table border="1" style="border-color: #ffffff"
																		...
																		<table border="1" style="border-color: #ffffff"
																			...
																			<tr>
																				...
																				<td align="center"
																					style="font-size:10pt;">
																					<span id="status4"
																						style="color: #28a745; font-weight: bold;">정상</span>
																				</td>
																			</tr>
																		</table>
																		<table border="1" style="border-color: #ffffff"
															...
															<div style="text-align: center; margin-top: 15px;">
																<c:if test="${userGrade ne 'B'}">
																	<button id="saveAlarm" name="saveAlarm"
																		style="width:120px; height:30px;">알람설정저장</button>
																</c:if>
																<c:if test="${userGrade eq 'B'}">
																	<span style="color: #999; font-size:10pt;">읽기 전용 (알람
																		설정 변경 불가)</span>
																</c:if>
															</div>
														</div>
							...
							<script>
											...
											function initializeSensorSetting() {
												...
												window.updateAlarmUI = function (settings) {
													...
													if (settings.re_delay_time1 !== undefined && settings.re_delay_time1 !== null) {
														...
														console.log('고온알람 재전송반복시간: ' + reHour1 + '시간 ' + reMin1 + '분');
													}
												...
												// 센서 정보 요청 (페이지 로딩 시)
												// 버퍼링 시스템으로 대체 - MQTT 연결 즉시 요청하고 페이지 로딩 완료 시 버퍼 데이터 적용
												// setTimeout(function () {
												// 	console.log('페이지 로딩 완료 - 센서 정보 요청');
												// 	setSensor();
												// }, 3000); // MQTT 연결 후 3초 뒤에 센서 정보 요청
												
												// 버퍼 데이터 적용 (페이지 로딩 완료 시)
												if (typeof UnifiedMQTTManager !== 'undefined' && 
													typeof UnifiedMQTTManager.applyBufferedData === 'function') {
													console.log('[센서설정] 버퍼 데이터 적용');
													UnifiedMQTTManager.applyBufferedData();
												} else {
													console.warn('[센서설정] UnifiedMQTTManager 또는 applyBufferedData 함수가 없음 - fallback으로 setSensor 호출');
													setTimeout(function () {
														console.log('[센서설정] Fallback - 센서 정보 요청');
														setSensor();
													}, 3000);
												}
								...
								function updateSensorInfo(msg) {
									...
									window.deviceType = deviceType; // 전역 변수에 장치 타입 저장 (히터/쿨러 아이콘 표시용)
												...
												if (uuid == $('#sensorUuid').val()) {
													if (msg.actcode == 'live') {
														...
														if (msg.name == 'ain') {
															...
															// output 상태 변화 알림
															// 장치 타입 가져오기 (전역 변수에서)
															var currentDeviceType = window.deviceType || '0';
															...
															if (msg.value == '1') {
																if (msg.type == '1') {
																	...
																	// def 이상 - 아이콘도 함께 업데이트
																	updateDefrostIndicator('defr' + uuid, 'red', currentDeviceType);
																	// 제상 버튼 밝기 업데이트
																...
																if (msg.type == '1') {
																	...
																	// def 해제 - 아이콘도 함께 업데이트
																	updateDefrostIndicator('defr' + uuid, 'gray', currentDeviceType);
																	// 제상 버튼 밝기 업데이트
								...
								function chkError() {
									...
									if (timeDiff > 9000 && !deviceErrorStates) {
										...
										if (deviceErrorCounters >= 3) {
											...
											updateDefrostIndicator('defr' + sensorUuid, 'gray', currentDeviceType); // 아이콘도 함께 업데이트
